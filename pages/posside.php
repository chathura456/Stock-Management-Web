...
<div class="card-body col-md-3">
  <?php
  $total = 0; // Initialize $total before the if statement
    ...
    <div class="form-group row text-left mb-3">
      <div class="col-sm-12 text-primary btn-group">
        ...
        <a href="#" data-toggle="modal" data-target="#poscustomerModal" type="button"
          class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a>
      </div>
    ...
    <div class="form-group row mb-2">
      ...
      <div class="col-sm-7">
        <div class="input-group mb-2">
          ...
          <input type="text" class="form-control text-right " value="<?php echo number_format($lessvat, 2); ?>" readonly
            name="lessvat">
        </div>
      </div>
    ...
    <div class="form-group row mb-2">
      ...
      <div class="col-sm-7">
        <div class="input-group mb-2">
          ...
          <input type="text" class="form-control text-right " value="<?php echo number_format($netvat, 2); ?>" readonly
            name="netvat">
        </div>
      </div>
    ...
    <div class="form-group row mb-2">
      ...
      <div class="col-sm-7">
        <div class="input-group mb-2">
          ...
          <input type="text" class="form-control text-right " value="<?php echo number_format($addvat, 2); ?>" readonly
            name="addvat">
        </div>
      </div>
        ...
        <div class="modal-body">
          ...
          <div class="col-sm-12 mb-2">
            <div class="input-group mb-2">
              ...
              <input class="form-control text-right" id="txtNumber" onkeypress="return isNumberKey(event)" type="text"
                name="cash" placeholder="ENTER CASH" name="cash" required>
            </div>
          </div>
        </div>
