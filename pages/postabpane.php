...
<div class="tab-content">
  <!-- 1st TAB -->
  <div class="tab-pane fade show active in mt-2" id="seeds">
    <div class="row">
  ...
  <!-- 2nd TAB -->
  <div class="tab-pane fade in mt-2" id="fertilizers">
    <div class="row">
  ...
  <!-- 3rd TAB -->
  <div class="tab-pane fade in mt-2" id="pesticides">
    <div class="row">
  ...
  <!-- 4th TAB -->
  <div class="tab-pane fade in mt-2" id="tools">
    <div class="row">
  ...
  <!-- 5th TAB -->
  <div class="tab-pane fade in mt-2" id="machinery">
    <div class="row">
  ...
  <!-- 6th TAB -->
  <div class="tab-pane fade in mt-2" id="irrigation">
    <div class="row">
  ...
  <!-- 7th TAB -->
  <div class="tab-pane fade in mt-2" id="harvesting">
    <div class="row">
  ...
  <!-- 8th TAB -->
  <div class="tab-pane fade in mt-2" id="gear">
    <div class="row">
      <?php $query = 'SELECT * FROM product WHERE CATEGORY_ID=8 GROUP BY PRODUCT_CODE ORDER by PRODUCT_CODE ASC';
      $result = mysqli_query($db, $query);
  ...
  <!-- 9th TAB -->
  <div class="tab-pane fade in mt-2" id="saplings">
    <div class="row">
